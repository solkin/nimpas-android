 ...
 * the License.
 */
package com.tomclaw.bottomsheet;
...
import com.tomclaw.bottomsheet.adapter.DividableGridAdapter;
import com.tomclaw.bottomsheet.model.AbstractItem;
import com.tomclaw.bottomsheet.model.Divider;
import com.tomclaw.bottomsheet.model.Item;
import com.tomclaw.bottomsheet.util.DisplayUtil;
import com.tomclaw.bottomsheet.view.DividableGridView;
import com.tomclaw.bottomsheet.view.DraggableView;

import java.util.List;

import static android.os.Build.VERSION_CODES;
import static com.tomclaw.bottomsheet.util.Condition.ensureAtLeast;
import static com.tomclaw.bottomsheet.util.Condition.ensureAtMaximum;
import static com.tomclaw.bottomsheet.util.Condition.ensureNotNull;
import static com.tomclaw.bottomsheet.util.DisplayUtil.getDeviceType;
import static com.tomclaw.bottomsheet.util.DisplayUtil.getOrientation;
 ...
 * Builder#show()} of the builder {@link com.tomclaw.bottomsheet.BottomSheet.Builder} can be
 * used.
 *
 * @author Michael Rapp
 * @since 1.0.0
...
public class BottomSheet extends Dialog implements DialogInterface, DraggableView.Callback {
    ...
    public static class Builder {
         ...
         *
         * @param context         The context, which should be used by the builder, as an instance of the class
         ...
         *
         * @param themeResourceId The resource id of the theme, the background should be obtained from, as an
         *                        {@link Integer} value
         */
         ...
         *
         * @param themeResourceId The resource id of the theme, the title color should be obtained from, as an
         *                        {@link Integer} value
         */
         ...
         *
         * @param themeResourceId The resource id of the theme, the divider color should be obtained from, as an
         *                        {@link Integer} value
         */
         ...
         *
         * @param themeResourceId The resource id of the theme, the item color should be obtained from, as an
         *                        {@link Integer} value
         */
         ...
         *
         * @param themeResourceId The resource id of the theme, the dim amount should be obtained from, as an
         *                        {@link Integer} value
         */
         ...
         *
         * @param themeResourceId The resource id of the theme, the drag sensitivity should be obtained from, as an
         *                        {@link Integer} value
         */
         ...
         * @param context         The context, which should be used by the builder, as an instance of the class
         *                        {@link Context}. The context may not be null
         * @param themeResourceId The resource id of the theme, which should be used by the bottom sheet, as an
         ...
         * not.
         *
         * @param cancelable True, if the bottom sheet, which is created by the builder, should be cancelable,
         *                   false otherwise
         ...
         *
         * @param style The style, which should be set, as a value of the enum {@link Style}. The style
         ...
         * not just when it is canceled, see {@link #setOnDismissListener(OnDismissListener)
         ...
         *
         * @param color The color, which should be set, as an {@link Integer} value or -1, if no custom
         *              color should be set
         * @return The builder, the method has been called upon, as an instance of the class {@link
         * Builder}
         */
         ...
         *
         * @param background The background, which should be set, as an instance of the class {@link Bitmap}
         ...
         * Sets the background of the bottom sheet, which is created by the builder.
         *
         * @param resourceId The resource id of the background, which should be set, as an {@link Integer}
         ...
         *
         * @param color The background color, which should be set, as an {@link Integer} value or -1, if
         ...
         *
         * @param title The title, which should be set, as an instance of the type {@link CharSequence}
         ...
         * Sets the title of the bottom sheet, which is created by the builder.
         *
         * @param resourceId The resource id of the title, which should be set, as an {@link Integer} value.
         ...
         *
         * @param icon The icon, which should be set, as an instance of the class {@link Bitmap} or
         ...
         * Sets the icon of the bottom sheet, which is created by the builder.
         *
         * @param resourceId The resource id of the icon, which should be set, as an {@link Integer} value.
         ...
         *
         * @param attributeId The id of the theme attribute, which supplies the icon, which should be set, as
         ...
         * builder.
         *
         * @param view The view, which should be set, as an instance of the class {@link View} or null,
         ...
         * builder.
         *
         * @param resourceId The resource id of the view, which should be set, as an {@link Integer} value.
         ...
         *
         * @param dragSensitivity The drag sensitivity, which should be set, as a {@link Float} value. The drag
         ...
         * which is created by the builder.
         *
         * @param dimAmount The dim amount, which should be set, as a {@link Float} value. The dim amount
         ...
         *
         * @param width The width, which should be set, in pixels as an {@link Integer} value. The width
         *              must be at least 1
         * @return The builder, the method has been called upon, as an instance of the class {@link
         * Builder}
         */
         ...
         *
         * @param id    The id of the item, which should be added, as an {@link Integer} value. The id
         *              must be at least 0
         * @param title The title of the item, which should be added, as an instance of the type {@link
         ...
         * @param title The title of the item, which should be added, as an instance of the type {@link
         *              CharSequence}. The title may neither be null, nor empty
         * @param icon  The icon of the item, which should be added, as an instance of the class {@link
         ...
         * @param id      The id of the item, which should be added, as an {@link Integer} value. The id
         *                must be at least 0
         * @param titleId The resource id of the title of the item, which should be added, as an {@link
         ...
         * @param titleId The resource id of the title of the item, which should be added, as an {@link
         *                Integer} value. The resource id must correspond to a valid string resource
         * @param iconId  The resource id of the icon of the item, which should be added, as an {@link
         ...
         * Adds a new divider to the bottom sheet, which is created by the builder.
         *
         * @param title The title of the divider, which should be added, as an instance of the type
         ...
         * Adds a new divider to the bottom sheet, which is created by the builder.
         *
         * @param titleId The resource id of the title, which should be added, as an {@link Integer} value.
         *                The resource id must correspond to a valid string resource
         * @return The builder, the method has been called upon, as an instance of the class {@link
         * Builder}
         */
         ...
         *
         * @param index   The index of the item as an {@link Integer} value
         ...
         *
         * @param activity The activity, the bottom sheet, which is created by the builder, belongs to, as
         *                 an instance of the class {@link Activity}. The activity may not be null
         * @param intent   The intent as an instance of the class {@link Intent}. The intent may not be
         *                 null
         * @return The builder, the method has been called upon, as an instance of the class {@link
         * Builder}
         */
     ...
     *
     * @param activity     The activity, the bottom sheet belongs to, as an instance of the class {@link
     *                     Activity}. The activity may not be null
     * @param intent       The intent, which should be passed to the started app, as an instance of the class
     *                     {@link Intent}. The intent may not be null
     * @param resolveInfos A list, which contains the resolve infos, which correspond to the apps, which are
     ...
     *
     * @param context         The context, which should be used by the bottom sheet, as an instance of the class
     *                        {@link Context}. The context may not be null
     * @param themeResourceId The resource id of the theme, which should be used by the bottom sheet, as an {@link
     ...
     *
     * @param attributeId The id of the theme attribute, which supplies the icon, which should be set, as an
     ...
     *
     * @param background The background, which should be set, as an instance of the class {@link Bitmap} or
     ...
     * Sets the background of the bottom sheet.
     *
     * @param resourceId The resource id of the background, which should be set, as an {@link Integer} value.
     *                   The resource id must correspond to a valid drawable resource
     */
     ...
     *
     * @param color The background color, which should be set, as an {@link Integer} value or -1, if no
     ...
     * Sets the dim amount, which should be used to darken the area outside the bottom sheet.
     *
     * @param dimAmount The dim amount, which should be set, as a {@link Float} value. The dim amount must be
     ...
     * mode.
     *
     * @param width The width, which should be set, in pixels as an {@link Integer} value. The width must
     *              be at least 1
     */
     ...
     *
     * @param id    The id of the item, which should be added, as an {@link Integer} value. The id must
     *              be at least 0
     * @param title The title of the item, which should be added, as an instance of the type {@link
     *              CharSequence}. The title may neither be null, nor empty
     */
     ...
     * @param titleId The resource id of the title of the item, which should be added, as an {@link
     *                Integer} value. The resource id must correspond to a valid string resource
     * @param iconId  The resource id of the icon of the item, which should be added, as an {@link Integer}
     *                value. The resource id must correspond to a valid drawable resource
     */
    public final void addItem(final int id, @StringRes final int titleId,
                              @DrawableRes final int iconId) {
     ...
     *
     * @param index The index of the item, which should be replaced, as an {@link Integer} value
     * @param id    The id of the item, which should be added, as an {@link Integer} value. The id must
     *              be at least 0
     * @param title The title of the item, which should be added, as an instance of the type {@link
     *              CharSequence}. The title may neither be null, nor empty
     ...
     * Adds a new divider to the bottom sheet.
     *
     * @param title The title of the divider, which should be added, as an instance of the type {@link
     ...
     * Adds a new divider to the bottom sheet.
     *
     * @param titleId The resource id of the title of the divider, which should be added, as an {@link
     *                Integer} value. The resource id must correspond to a valid string resource
     */
     ...
     *
     * @param index The index of the item, which should be removed, as an {@link Integer} value
     */
     ...
     *
     * @param id The id of the item, whose index should be returned, as an {@link Integer} value. The
     ...
     *
     * @param index The index of the item, whose id should be returned, as an {@link Integer} value
     ...
     *
     * @param index The index of the item, which should be checked, as an {@link Integer} value
     ...
     * @param activity The activity, the bottom sheet belongs to, as an instance of the class {@link
     *                 Activity}. The activity may not be null
     * @param intent   The intent as an instance of the class {@link Intent}. The intent may not be null
     */
     ...
     * changed, or not.
     *
     * @param invalidateOnChange True, if the bottom sheet should automatically be invalidated, when its items have
     ...
     *
     * @param style The style, which should be set, as a value of the enum {@link Style}. The style may
