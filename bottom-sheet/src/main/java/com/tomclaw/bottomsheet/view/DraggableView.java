 ...
 * the License.
 */
package com.tomclaw.bottomsheet.view;
...
import com.tomclaw.bottomsheet.animation.DraggableViewAnimation;
import com.tomclaw.bottomsheet.util.DisplayUtil.DeviceType;
import com.tomclaw.bottomsheet.util.gesture.DragHelper;
...
public class DraggableView extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public interface Callback {
         ...
         *
         * @param canceled True, if the view has been canceled, false otherwise
         */
     ...
     * up.
     *
     * @param x The horizontal position of the touch event in pixels as a {@link Float} value
     * @param y The vertical position of the touch event in pixels as a {@link Float} value
     ...
     * @param x         The horizontal position of the touch event in pixels as a {@link Float} value
     * @param y         The vertical position of the touch event in pixels as a {@link Float} value
     * @param viewGroup The view group, which should be used to search for scrollable child views, as an
     ...
     *
     * @param margin The top margin, which should be set, in pixels as an {@link Integer} value
     */
     ...
     *
     * @param diff           The distance the view has to be vertically moved by, as an {@link Integer} value
     * @param animationSpeed The speed of the animation in pixels per milliseconds as a {@link Float} value
     ...
     * @param interpolator   The interpolator, which should be used by the animation, as an instance of the type
     *                       {@link Interpolator}. The interpolator may not be null
     * @param cancel         True, if the view should be canceled, false otherwise
     */
     ...
     *
     * @param diff              The distance the view has to be vertically moved by, as an {@link Integer} value
     * @param animationSpeed    The speed of the animation in pixels per millisecond as a {@link Float} value
     * @param animationListener The listener, which should be notified about the animation's progress, as an instance
     ...
     *
     * @param show   True, if the view should be shown at the end of the animation, false otherwise
     * @param cancel True, if the view should be canceled, false otherwise
     ...
     *
     * @param dragSensitivity The distance, which should be set, in pixels as an {@link Integer} value. The value
     *                        must be at least 0
     */
