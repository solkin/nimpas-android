...
public class ScrimInsetsLayout extends FrameLayout {
    ...
    public interface Callback {
         ...
         *
         * @param insets The new insets as an instance of the class {@link Rect}. The insets may not be
         *               null
         */
     ...
     * array.
     *
     * @param typedArray The typed array, the drawable should be obtained from, as an instance of the class
     ...
     *
     * @param insets The new insets as an instance of the class {@link Rect}
     */
     ...
     *
     * @param insetForeground The drawable, which should be set, as an instance of the class {@link Drawable}, or
