 ...
 * the License.
 */
package com.tomclaw.bottomsheet.util.view;
...
import com.tomclaw.bottomsheet.util.ElevationUtil;
import com.tomclaw.bottomsheet.util.ElevationUtil.Orientation;
...
import static com.tomclaw.bottomsheet.util.DisplayUtil.pixelsToDp;
import static com.tomclaw.bottomsheet.util.ElevationUtil.createElevationShadow;
...
public class ElevationShadowView extends AppCompatImageView {
     ...
     * array.
     *
     * @param typedArray The typed array, the elevation should be obtained from, as an instance of the class
     ...
     *
     * @param typedArray The typed array, the boolean value should be obtained from, as an instance of the
     ...
     *
     * @param elevation The elevation of the shadow, which should be set, in dp as an {@link Integer} value.
     ...
     *
     * @param orientation The orientation, which should be set, as a value of the enum {@link Orientation}. The
