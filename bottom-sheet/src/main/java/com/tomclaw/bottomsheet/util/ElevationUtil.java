...
import static com.tomclaw.bottomsheet.util.DisplayUtil.dpToPixels;
...
public final class ElevationUtil {
    ...
    public enum Orientation {
         ...
         *
         * @param value The value of the orientation
         */
         ...
         *
         * @param value The value, the orientation, which should be returned, corresponds to, as an
         *              {@link Integer} value
     ...
     * @param elevation     The elevation, which should be emulated, in dp as an {@link Integer} value. The
     *                      elevation must be at least 0 and at maximum the value of the constant
     *                      <code>MAX_ELEVATION</code>
     * @param orientation   The orientation of the shadow in relation to the elevated view as a value of the enum
     ...
     * @param parallelLight True, if parallel light should be emulated, false otherwise
     ...
     *
     * @param orientation           TThe orientation of the shadow in relation to the elevated view as a value of the
     *                              enum {@link Orientation}. The orientation may either be <code>TOP_LEFT</code>,
     *                              <code>TOP_RIGHT</code>, <code>BOTTOM_LEFT</code> or <code>BOTTOM_RIGHT</code>
     * @param horizontalShadowColor The color of the shadow, which is located next to the corner in horizontal direction,
     *                              as an {@link Integer} value
     * @param verticalShadowColor   The color of the shadow, which is located next to the corner in vertical direction,
     *                              as an {@link Integer}  value
     ...
     *                    {@link Orientation}. The orientation may either be <code>TOP_LEFT</code>,
     *                    <code>TOP_RIGHT</code>, <code>BOTTOM_LEFT</code> or <code>BOTTOM_RIGHT</code>
     * @param size        The size of the bitmap, which is used to draw the shadow, in pixels as an {@link
     *                    Integer} value
     ...
     *                      {@link Orientation}. The orientation may either be <code>TOP_LEFT</code>,
     *                      <code>TOP_RIGHT</code>, <code>BOTTOM_LEFT</code> or <code>BOTTOM_RIGHT</code>
     * @param parallelLight True, if the parallel light should be emulated, false otherwise
     ...
     *                        elevation must be at least 0 and at maximum the value of the constant
     *                        <code>MAX_ELEVATION</code>
     * @param minTransparency The minimum alpha value, which should be used, if the given elevation is 0, as an
     *                        {@link Integer} value between 0 and 255
     * @param maxTransparency The maximum alpha value, which should be used, if the given elevation is
     ...
     *                     {@link Orientation}. The orientation may either be <code>LEFT</code>,
     *                     <code>TOP</code>, <code>RIGHT</code> or <code>BOTTOM</code>
     * @param bitmapWidth  The width of the bitmap, which is used to draw the shadow, in pixels as an {@link
     *                     Integer} value
     * @param bitmapHeight The height of the bitmap, which is used to draw the shadow, in pixels as an {@link
     *                     Integer} value
     * @param shadowWidth  The width of the shadow in pixels as a {@link Float} value
     * @param shadowColor  The color of the shadow as an {@link Integer} value
     ...
     *                    {@link Orientation}. The orientation may either be <code>TOP_LEFT</code>,
     *                    <code>TOP_RIGHT</code>, <code>BOTTOM_LEFT</code> or <code>BOTTOM_RIGHT</code>
     * @param bitmapSize  The size of the bitmap, which is used to draw the shadow, in pixels as an {@link
     *                    Integer} value
     * @param radius      The radius, which should be used to draw the shadow, in pixels as a {@link Float}
     *                    value
     * @return The shader, which has been created as an instance of the class {@link Shader}
     */
