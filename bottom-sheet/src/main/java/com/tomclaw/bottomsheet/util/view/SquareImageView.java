...
public class SquareImageView extends AppCompatImageView {
    ...
    public enum Edge {
         ...
         *
         * @param value The value of the edge, which should be returned, as an {@link Integer} value
     ...
     *
     * @param typedArray The typed array, the scaled edge should be obtained from, as an instance of the class
     ...
     *
     * @param context The context, which should be used by the image view, as an instance of the class
     ...
     * @param context      The context, which should be used by the image view, as an instance of the class
     *                     {@link Context}. The context may not be null
     * @param attributeSet The attributes of the XML tag that is inflating the view, as an instance of the type
     ...
     *
     * @param edge The edge, which should be set, as a value of the enum {@link Edge}. The edge may
