 ...
 * the License.
 */
package com.tomclaw.bottomsheet.model;
...
import static com.tomclaw.bottomsheet.util.Condition.ensureNotEmpty;
...
public class Item extends AbstractItem {
     ...
     * Creates a new item.
     *
     * @param id    The item's id as an {@link Integer} value. The id must be at least 0
     * @param title The item's title as an instance of the type {@link CharSequence}. The title may
     ...
     * @param id         The item's id as an {@link Integer} value
     * @param resourceId The resource id of the item's title as an {@link Integer} value. The resource id must
