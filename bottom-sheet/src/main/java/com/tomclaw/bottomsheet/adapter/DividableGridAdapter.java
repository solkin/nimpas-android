 ...
 * the License.
 */
package com.tomclaw.bottomsheet.adapter;
...
import com.tomclaw.bottomsheet.BottomSheet.Style;
import com.tomclaw.bottomsheet.R;
...
import com.tomclaw.bottomsheet.util.DisplayUtil.DeviceType;
import com.tomclaw.bottomsheet.util.DisplayUtil.Orientation;
...
public class DividableGridAdapter extends BaseAdapter {
     ...
     *
     * @param item       The item, which should be visualized, as an instance of the class {@link Item}. The
     *                   item may not be null
     * @param viewHolder The view holder, which contains the views, which should be used to visualize the
     ...
     * @param parent   The parent of the view, which should be inflated, as an instance of the class {@link
     *                 ViewGroup} or null, if no parent is available
     * @param divider  The divider, which should be visualized, as an instance of the class {@link Divider}.
     *                 The divider may not be null
     * @param position The position of the divider, which should be visualized, as an {@link Integer} value
     * @return The view, which has been inflated, as an instance of the class {@link View}
     */
     ...
     *
     * @param context The context, which should be used by the adapter, as an instance of the class {@link
     *                Context}. The context may not be null
     * @param style   The style, which should be used to display the adapter's items, as a value of the
     *                enum {@link Style}. The style may either be <code>LIST</code>,
     *                <code>LIST_COLUMNS</code> or <code>GRID</code>
     * @param width   The width of the bottom sheet, the items, which are displayed by the adapter, belong
     ...
     * to.
     *
     * @param width The width, which should be set, as an {@link Integer} value
     */
     ...
     *
     * @param color The text color, which should be set, as an {@link Integer} value or -1, if no custom
     *              color should be set
     */
     ...
     *
     * @param item The item, which should be added, as an instance of the class {@link AbstractItem}.
     ...
     * @param item  The item, which should be set, as an instance of the class {@link AbstractItem}. The
     *              item may not be null
     */
     ...
     *
     * @param notifyOnChange True, if the <code>notifyDataSetChanged</code>-method should be called automatically,
