 ...
 * the License.
 */
package com.tomclaw.bottomsheet.animation;
...
public class DraggableViewAnimation extends Animation {
     ...
     *
     * @param view     The view, which should be animated, as an instance of the class {@link
     *                 DraggableView}. The view may not be null
     * @param diff     The distance, the view should be vertically moved by, as an {@link Integer} value. If
     *                 the value is negative, the view's height will be increased, if it is positive, the
     *                 view's height will be increased
     * @param duration The duration of the animation in milliseconds, as a {@link Long} value. The duration
