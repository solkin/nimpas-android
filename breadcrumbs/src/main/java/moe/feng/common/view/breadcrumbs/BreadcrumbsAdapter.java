...
class BreadcrumbsAdapter extends RecyclerView.Adapter<BreadcrumbsAdapter.ItemHolder> {
    ...
    public BreadcrumbsAdapter(BreadcrumbsView parent, int mTextColorSelected, int mtextColorUnSelected, int mTextSize) {
        this(parent, new ArrayList<IBreadcrumbItem>());
        this.mTextColorSelected = mTextColorSelected;
        this.mtextColorUnSelected = mtextColorUnSelected;
    ...
    public @NonNull
    <E extends IBreadcrumbItem> List<E> getItems() {
